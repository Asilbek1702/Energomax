...
const TopBar = () => {
  return (
    ...
    >
      <div className="w-full px-4 sm:px-6 lg:px-10 flex flex-col sm:flex-row items-start sm:items-center justify-between py-2 gap-2 sm:gap-0">
        <div className="flex flex-wrap items-center gap-4 sm:gap-6">
          ...
          <span className="hidden md:flex items-center gap-1.5" style={{ color: "var(--industrial-text-muted)" }}>
            <MapPin size={11} />
            <span>Ташкент, Узбекистан</span>
          </span>
        </div>
        <div className="flex items-center gap-1.5" style={{ color: "var(--industrial-text-muted)" }}>
          <Clock size={11} />
